...
import com.dblab.webservice.domain.user.controller.springdocs.model.AuthInvalidTokenException;
import com.dblab.webservice.domain.user.controller.springdocs.model.ServerErrorException;
...
@ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "401", description = "ID TOKEN이 유효하지 않음",
